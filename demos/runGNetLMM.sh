...
#do
#    ./../GNetLMM/bin/gNetLMM_analyse --find_vstructures  --pfile $PFILE  --gfile $GFILE --cisfile $CISFILE --assoc0f#ile $ASSOC0FILE --window $WINDOW --vfile $VFILE.startTrait_$i --bfile $BFILE --startTraitIdx $i --nTraits 10
    
#     ./../GNetLMM/bin/gNetLMM_analyse --update_assoc --bfile $BFILE --pfile $PFILE --cfile $CFILE.cov  --vfile $VFIL#E.startTrait_$i --assocfile $ASSOCFILE.startTrait_$i --startTraitIdx $i --nTraits 10
#done
